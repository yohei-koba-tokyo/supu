...
　　1．rspecによる単体テストと統合テストの実装 **→ 2020年4月7日、実装済**

　　2．レスポンシブデザインの実装 **→ 2020年4月13日、実装済**

　　3．チャットに、自動更新機能を実装 **→ 2020年4月9日、実装済**

　　4．Dockerを用いた環境構築

　　5．他ユーザーからミッション共有リクエストを受けた際の、通知機能と表示機能を実装

　　6．他ユーザーからのミッション共有リクエストに対する承諾/拒否機能を実装

　　7．チャット通知機能　メンション機能の実装
